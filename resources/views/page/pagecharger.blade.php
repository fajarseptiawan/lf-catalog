...
@section('title', 'Charger iPhone - LF Catalog')
...
@section('content')
    ...
    <section class="pt-20 pb-10 text-center bg-white border-b border-gray-300">
        <div class="max-w-xl mx-auto px-4">
            ...
            <p class="text-sm text-gray-500 mb-8">
                Charger original & berkualitas untuk iPhone
            </p>

            <div class="reveal-left opacity-0 translate-y-20 transition-all duration-1000 ease-out">
                <img src="{{ asset('img/tes.png') }}" class="mx-auto max-w-4xl w-full" alt="Charger iPhone">
            </div>
        </div>
    </section>
    ...
    @push('js')
        <script src="{{ asset('assets/pagecharger.js') }}"></script>
    @endpush
@endsection
