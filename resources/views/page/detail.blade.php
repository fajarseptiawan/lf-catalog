...
<section class="max-w-4xl mx-auto px-4 py-8">
    ...
    <div class="mt-8 flex flex-col gap-3">
        <button onclick="addToCart()" class="w-full flex items-center justify-center bg-gray-900 hover:bg-gray-800 text-white font-bold py-4 px-8 rounded-full transition duration-300 shadow-lg text-lg {{ $product->stock < 1 ? 'opacity-50 cursor-not-allowed' : '' }}" {{ $product->stock < 1 ? 'disabled' : '' }}>
